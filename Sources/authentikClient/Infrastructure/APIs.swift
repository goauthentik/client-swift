...
open class authentikClientAPIConfiguration: @unchecked Sendable {
    ...
    public static let shared = authentikClientAPIConfiguration()
}
...
open class RequestBuilder<T>: @unchecked Sendable, Identifiable {
    ...
    public let apiConfiguration: authentikClientAPIConfiguration

    /// Optional block to obtain a reference to the request's progress instance when available.
    public var onProgressReady: ((Progress) -> Void)?

    required public init(method: String, URLString: String, parameters: [String: any Sendable]?, headers: [String: String] = [:], requiresAuthentication: Bool, apiConfiguration: authentikClientAPIConfiguration = authentikClientAPIConfiguration.shared) {
        self.method = method
