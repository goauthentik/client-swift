...
/** WebAuthn Challenge */
public struct AuthenticatorWebAuthnChallenge: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public var registration: [String: JSONValue]

    public init(flowInfo: ContextualFlowInfo? = nil, component: String? = "ak-stage-authenticator-webauthn", responseErrors: [String: [ErrorDetail]]? = nil, pendingUser: String, pendingUserAvatar: String, registration: [String: JSONValue]) {
