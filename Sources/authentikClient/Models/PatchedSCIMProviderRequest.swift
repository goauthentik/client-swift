...
public struct PatchedSCIMProviderRequest: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public var groupFilters: [UUID]?
    /** When enabled, provider will not modify or create objects in the remote system. */
    public var dryRun: Bool?

    public init(name: String? = nil, propertyMappings: [UUID]? = nil, propertyMappingsGroup: [UUID]? = nil, url: String? = nil, verifyCertificates: Bool? = nil, token: String? = nil, authMode: SCIMAuthenticationModeEnum? = nil, authOauth: UUID? = nil, authOauthParams: [String: JSONValue]? = nil, compatibilityMode: CompatibilityModeEnum? = nil, serviceProviderConfigCacheTimeout: String? = nil, excludeUsersServiceAccount: Bool? = nil, syncPageSize: Int? = nil, syncPageTimeout: String? = nil, groupFilters: [UUID]? = nil, dryRun: Bool? = nil) {
        self.name = name
    ...
    public enum CodingKeys: String, CodingKey, CaseIterable {
        ...
        case groupFilters = "group_filters"
        case dryRun = "dry_run"
    }
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(groupFilters, forKey: .groupFilters)
