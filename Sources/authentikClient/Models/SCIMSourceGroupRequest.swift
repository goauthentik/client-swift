...
public struct SCIMSourceGroupRequest: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(id: String? = nil, externalId: String, group: UUID, source: UUID, attributes: [String: JSONValue]? = nil) {
        self.id = id
...
extension SCIMSourceGroupRequest: Identifiable {}
