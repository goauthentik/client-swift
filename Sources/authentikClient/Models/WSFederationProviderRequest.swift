//
// WSFederationProviderRequest.swift
//
...
public struct WSFederationProviderRequest: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(name: String, authenticationFlow: UUID? = nil, authorizationFlow: UUID, invalidationFlow: UUID, propertyMappings: [UUID]? = nil, replyUrl: String, assertionValidNotBefore: String? = nil, assertionValidNotOnOrAfter: String? = nil, sessionValidNotOnOrAfter: String? = nil, nameIdMapping: UUID? = nil, authnContextClassRefMapping: UUID? = nil, digestAlgorithm: DigestAlgorithmEnum? = nil, signatureAlgorithm: SignatureAlgorithmEnum? = nil, signingKp: UUID? = nil, encryptionKp: UUID? = nil, signAssertion: Bool? = nil, signLogoutRequest: Bool? = nil, defaultNameIdPolicy: SAMLNameIDPolicyEnum? = nil) {
        self.name = name
