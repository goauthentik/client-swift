//
// PatchedRACProviderRequest.swift
//
...
public struct PatchedRACProviderRequest: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(name: String? = nil, authenticationFlow: UUID? = nil, authorizationFlow: UUID? = nil, propertyMappings: [UUID]? = nil, settings: [String: JSONValue]? = nil, connectionExpiry: String? = nil, deleteTokenOnDisconnect: Bool? = nil) {
        self.name = name
