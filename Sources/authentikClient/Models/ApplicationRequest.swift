...
public struct ApplicationRequest: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(name: String, slug: String, provider: Int? = nil, backchannelProviders: [Int]? = nil, openInNewTab: Bool? = nil, metaLaunchUrl: String? = nil, metaIcon: String? = nil, metaDescription: String? = nil, metaPublisher: String? = nil, policyEngineMode: PolicyEngineMode? = nil, group: String? = nil) {
        self.name = name
        self.slug = slug
