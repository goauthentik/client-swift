...
public struct SSFProviderRequest: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(name: String, signingKey: UUID, oidcAuthProviders: [Int]? = nil, eventRetention: String? = nil) {
        self.name = name
