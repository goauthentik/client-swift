...
public struct ConsentChallenge: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(flowInfo: ContextualFlowInfo? = nil, component: String? = "ak-stage-consent", responseErrors: [String: [ErrorDetail]]? = nil, pendingUser: String, pendingUserAvatar: String, headerText: String? = nil, permissions: [ConsentPermission], additionalPermissions: [ConsentPermission], token: String) {
