...
public struct AppleLoginChallenge: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(flowInfo: ContextualFlowInfo? = nil, component: String? = "ak-source-oauth-apple", responseErrors: [String: [ErrorDetail]]? = nil, clientId: String, scope: String, redirectUri: String, state: String) {
