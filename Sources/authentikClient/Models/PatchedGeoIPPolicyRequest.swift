//
// PatchedGeoIPPolicyRequest.swift
//
...
public struct PatchedGeoIPPolicyRequest: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(name: String? = nil, executionLogging: Bool? = nil, asns: [Int]? = nil, countries: [CountryCodeEnum]? = nil, checkHistoryDistance: Bool? = nil, historyMaxDistanceKm: Int64? = nil, distanceToleranceKm: Int? = nil, historyLoginCount: Int? = nil, checkImpossibleTravel: Bool? = nil, impossibleToleranceKm: Int? = nil) {
        self.name = name
