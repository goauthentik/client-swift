//
// PatchedUserPlexSourceConnectionRequest.swift
//
...
public struct PatchedUserPlexSourceConnectionRequest: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(user: Int? = nil, source: UUID? = nil, identifier: String? = nil, plexToken: String? = nil) {
        self.user = user
        self.source = source
