...
public struct RedirectStageRequest: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(name: String, flowSet: [FlowSetRequest]? = nil, keepContext: Bool? = nil, mode: RedirectStageModeEnum, targetStatic: String? = nil, targetFlow: UUID? = nil) {
        self.name = name
