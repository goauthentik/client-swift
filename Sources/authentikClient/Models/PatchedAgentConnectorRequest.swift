...
public struct PatchedAgentConnectorRequest: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(connectorUuid: UUID? = nil, name: String? = nil, enabled: Bool? = nil, snapshotExpiry: String? = nil, authTerminateSessionOnExpiry: Bool? = nil, refreshInterval: String? = nil, authorizationFlow: UUID? = nil, nssUidOffset: Int? = nil, nssGidOffset: Int? = nil, challengeKey: UUID? = nil, jwtFederationProviders: [Int]? = nil) {
