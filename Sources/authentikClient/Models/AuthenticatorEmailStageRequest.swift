//
// AuthenticatorEmailStageRequest.swift
//
...
public struct AuthenticatorEmailStageRequest: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(name: String, configureFlow: UUID? = nil, friendlyName: String? = nil, useGlobalSettings: Bool? = nil, host: String? = nil, port: Int? = nil, username: String? = nil, password: String? = nil, useTls: Bool? = nil, useSsl: Bool? = nil, timeout: Int? = nil, fromAddress: String? = nil, subject: String? = nil, tokenExpiry: String? = nil, template: String? = nil) {
        self.name = name
