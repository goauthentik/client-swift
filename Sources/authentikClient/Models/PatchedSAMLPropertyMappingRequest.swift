...
public struct PatchedSAMLPropertyMappingRequest: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public static let samlNameRule = StringRule(minLength: 1, maxLength: nil, pattern: nil)
