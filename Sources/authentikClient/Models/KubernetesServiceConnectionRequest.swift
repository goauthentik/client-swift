...
public struct KubernetesServiceConnectionRequest: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(name: String, local: Bool? = nil, kubeconfig: [String: JSONValue]? = nil, verifySsl: Bool? = nil) {
        self.name = name
        self.local = local
