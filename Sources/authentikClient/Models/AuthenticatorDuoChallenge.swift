...
/** Duo Challenge */
public struct AuthenticatorDuoChallenge: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(flowInfo: ContextualFlowInfo? = nil, component: String? = "ak-stage-authenticator-duo", responseErrors: [String: [ErrorDetail]]? = nil, pendingUser: String, pendingUserAvatar: String, activationBarcode: String, activationCode: String, stageUuid: String) {
