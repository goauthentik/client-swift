//
// PatchedDeviceUserBindingRequest.swift
//
...
public struct PatchedDeviceUserBindingRequest: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(policy: UUID? = nil, group: UUID? = nil, user: Int? = nil, target: UUID? = nil, negate: Bool? = nil, enabled: Bool? = nil, order: Int? = nil, timeout: Int? = nil, failureResult: Bool? = nil, isPrimary: Bool? = nil) {
        self.policy = policy
        self.group = group
        self.user = user
        self.target = target
