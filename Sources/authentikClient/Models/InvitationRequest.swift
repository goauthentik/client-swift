...
public struct InvitationRequest: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(name: String, expires: Date? = nil, fixedData: [String: JSONValue]? = nil, singleUse: Bool? = nil, flow: UUID? = nil) {
        self.name = name
