//
// NativeLogoutChallengeResponseRequest.swift
//
...
public struct NativeLogoutChallengeResponseRequest: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(component: String? = "ak-provider-saml-native-logout") {
