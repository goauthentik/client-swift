...
public struct UserDeleteStage: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(pk: UUID, name: String, component: String, verboseName: String, verboseNamePlural: String, metaModelName: String, flowSet: [FlowSet]) {
        self.pk = pk
        self.name = name
