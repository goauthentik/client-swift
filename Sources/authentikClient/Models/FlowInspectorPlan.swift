...
public struct FlowInspectorPlan: Sendable, Codable, ParameterConvertible, Hashable {

    public var currentStage: FlowStageBinding
    public var nextPlannedStage: FlowStageBinding
    /** Get the plan's context, sanitized */
    public var planContext: [String: JSONValue]
    /** Get a unique session ID */
    public var sessionId: String

    public init(currentStage: FlowStageBinding, nextPlannedStage: FlowStageBinding, planContext: [String: JSONValue], sessionId: String) {
