...
public struct FlowErrorChallenge: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(flowInfo: ContextualFlowInfo? = nil, component: String? = "ak-stage-flow-error", responseErrors: [String: [ErrorDetail]]? = nil, requestId: String, error: String? = nil, traceback: String? = nil) {
