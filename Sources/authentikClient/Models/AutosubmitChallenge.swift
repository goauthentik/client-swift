...
public struct AutosubmitChallenge: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(flowInfo: ContextualFlowInfo? = nil, component: String? = "ak-stage-autosubmit", responseErrors: [String: [ErrorDetail]]? = nil, url: String, attrs: [String: String], title: String? = nil) {
