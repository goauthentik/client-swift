//
// PatchedSourceStageRequest.swift
//
...
public struct PatchedSourceStageRequest: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(name: String? = nil, flowSet: [FlowSetRequest]? = nil, source: UUID? = nil, resumeTimeout: String? = nil) {
        self.name = name
