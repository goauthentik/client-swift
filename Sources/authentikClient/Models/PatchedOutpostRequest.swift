...
/** Outpost Serializer */
public struct PatchedOutpostRequest: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(name: String? = nil, type: OutpostTypeEnum? = nil, providers: [Int]? = nil, serviceConnection: UUID? = nil, config: [String: JSONValue]? = nil, managed: String? = nil) {
        self.name = name
        self.type = type
