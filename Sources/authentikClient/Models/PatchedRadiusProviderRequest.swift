...
public struct PatchedRadiusProviderRequest: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(name: String? = nil, authenticationFlow: UUID? = nil, authorizationFlow: UUID? = nil, invalidationFlow: UUID? = nil, propertyMappings: [UUID]? = nil, clientNetworks: String? = nil, sharedSecret: String? = nil, mfaSupport: Bool? = nil, certificate: UUID? = nil) {
        self.name = name
