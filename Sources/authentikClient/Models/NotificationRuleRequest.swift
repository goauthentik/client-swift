...
public struct NotificationRuleRequest: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(name: String, transports: [UUID]? = nil, severity: SeverityEnum? = nil, destinationGroup: UUID? = nil, destinationEventUser: Bool? = nil) {
        self.name = name
