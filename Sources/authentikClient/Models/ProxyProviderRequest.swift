...
public struct ProxyProviderRequest: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(name: String, authenticationFlow: UUID? = nil, authorizationFlow: UUID, invalidationFlow: UUID, propertyMappings: [UUID]? = nil, internalHost: String? = nil, externalHost: String, internalHostSslValidation: Bool? = nil, certificate: UUID? = nil, skipPathRegex: String? = nil, basicAuthEnabled: Bool? = nil, basicAuthPasswordAttribute: String? = nil, basicAuthUserAttribute: String? = nil, mode: ProxyMode? = nil, interceptHeaderAuth: Bool? = nil, cookieDomain: String? = nil, jwtFederationSources: [UUID]? = nil, jwtFederationProviders: [Int]? = nil, accessTokenValidity: String? = nil, refreshTokenValidity: String? = nil) {
        self.name = name
