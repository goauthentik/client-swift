...
public struct LDAPSourceRequest: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        serverUri = try container.decode(String.self, forKey: .serverUri)
        ...
        baseDn = try container.decode(String.self, forKey: .baseDn)
