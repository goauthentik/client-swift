...
public struct PatchedOAuthSourceRequest: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        providerType = try container.decodeIfPresent(ProviderTypeEnum.self, forKey: .providerType)
        ...
        consumerSecret = try container.decodeIfPresent(String.self, forKey: .consumerSecret)
