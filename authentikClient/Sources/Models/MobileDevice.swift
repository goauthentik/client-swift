...
public struct MobileDevice: Codable {
    ...
    public var lastCheckin: MobileDeviceInfo

    public init(verboseName: String, verboseNamePlural: String, metaModelName: String, pk: String, name: String, type: String, confirmed: Bool, lastCheckin: MobileDeviceInfo) {
    ...
    public init(from decoder: Decoder) throws {
        ...
        lastCheckin = try container.decode(MobileDeviceInfo.self, forKey: .lastCheckin)
    }
