...
/// Prompt Serializer 
public struct PatchedPromptRequest: Codable {
    ...
    public init(name: String? = nil, fieldKey: String? = nil, label: String? = nil, type: PromptTypeEnum? = nil, _required: Bool? = nil, placeholder: String? = nil, initialValue: String? = nil, order: Int? = nil, promptstageSet: [StageRequest]? = nil, subText: String? = nil, placeholderExpression: Bool? = nil, initialValueExpression: Bool? = nil) {
        self.name = name
    ...
    public init(from decoder: Decoder) throws {
        ...
        type = try container.decodeIfPresent(PromptTypeEnum.self, forKey: .type)
        ...
        promptstageSet = try container.decodeIfPresent([StageRequest].self, forKey: .promptstageSet)
