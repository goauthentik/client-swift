...
public struct LDAPPropertyMapping: Codable {
    public var pk: UUID
    ...
    public init(pk: UUID, managed: String? = nil, name: String, expression: String, component: String, verboseName: String, verboseNamePlural: String, metaModelName: String, objectField: String) {
        self.pk = pk
