...
public struct Flow: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        stages = try container.decode([UUID].self, forKey: .stages)
        policies = try container.decode([UUID].self, forKey: .policies)
        cacheCount = try container.decode(Int.self, forKey: .cacheCount)
