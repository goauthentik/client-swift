...
public struct OAuth2ProviderSetupURLs: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        authorize = try container.decode(String.self, forKey: .authorize)
        token = try container.decode(String.self, forKey: .token)
        userInfo = try container.decode(String.self, forKey: .userInfo)
        providerInfo = try container.decode(String.self, forKey: .providerInfo)
        logout = try container.decode(String.self, forKey: .logout)
        jwks = try container.decode(String.self, forKey: .jwks)
    }
