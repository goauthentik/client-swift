...
public struct NotificationRule: Codable {
    public var pk: UUID
    ...
    public init(from decoder: Decoder) throws {
        ...
        transports = try container.decodeIfPresent([UUID].self, forKey: .transports)
        severity = try container.decodeIfPresent(SeverityEnum.self, forKey: .severity)
        group = try container.decodeIfPresent(UUID.self, forKey: .group)
        groupObj = try container.decode(Group.self, forKey: .groupObj)
    }
