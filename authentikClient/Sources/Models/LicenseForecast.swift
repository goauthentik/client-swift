...
public struct LicenseForecast: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        forecastedInternalUsers = try container.decode(Int.self, forKey: .forecastedInternalUsers)
        forecastedExternalUsers = try container.decode(Int.self, forKey: .forecastedExternalUsers)
    }
