...
public struct PatchedAuthenticatorSMSStageRequest: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        provider = try container.decodeIfPresent(ProviderEnum.self, forKey: .provider)
        fromNumber = try container.decodeIfPresent(String.self, forKey: .fromNumber)
