...
public struct StaticDevice: Codable {
    ...
    public init(verboseName: String, verboseNamePlural: String, metaModelName: String, pk: String, name: String, type: String, confirmed: Bool, tokenSet: [StaticDeviceToken]) {
    ...
    public init(from decoder: Decoder) throws {
        ...
        tokenSet = try container.decode([StaticDeviceToken].self, forKey: .tokenSet)
    }
