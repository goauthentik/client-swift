...
/// SMS Setup challenge 
public struct AuthenticatorSMSChallenge: Codable {
    ...
    public init(type: ChallengeChoices, flowInfo: ContextualFlowInfo? = nil, component: String? = "ak-stage-authenticator-sms", responseErrors: [String: [ErrorDetail]]? = nil, pendingUser: String, pendingUserAvatar: String, phoneNumberRequired: Bool? = true) {
        self.type = type
    ...
    public init(from decoder: Decoder) throws {
        ...
        phoneNumberRequired = try container.decodeIfPresent(Bool.self, forKey: .phoneNumberRequired)
    }
