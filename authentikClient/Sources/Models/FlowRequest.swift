...
/// Flow Serializer 
public struct FlowRequest: Codable {
    ...
    public init(name: String, slug: String, title: String, designation: FlowDesignationEnum, policyEngineMode: PolicyEngineMode? = nil, compatibilityMode: Bool? = nil, layout: LayoutEnum? = nil, deniedAction: DeniedActionEnum? = nil, authentication: AuthenticationEnum? = nil) {
        self.name = name
        self.slug = slug
        self.title = title
