...
public struct OpenIDConnectConfiguration: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        userinfoEndpoint = try container.decode(String.self, forKey: .userinfoEndpoint)
        endSessionEndpoint = try container.decode(String.self, forKey: .endSessionEndpoint)
        introspectionEndpoint = try container.decode(String.self, forKey: .introspectionEndpoint)
        jwksUri = try container.decode(String.self, forKey: .jwksUri)
        responseTypesSupported = try container.decode([String].self, forKey: .responseTypesSupported)
        idTokenSigningAlgValuesSupported = try container.decode([String].self, forKey: .idTokenSigningAlgValuesSupported)
        subjectTypesSupported = try container.decode([String].self, forKey: .subjectTypesSupported)
        tokenEndpointAuthMethodsSupported = try container.decode([String].self, forKey: .tokenEndpointAuthMethodsSupported)
    }
