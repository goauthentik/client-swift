...
/// Duo Challenge 
public struct AuthenticatorDuoChallenge: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        activationBarcode = try container.decode(String.self, forKey: .activationBarcode)
        activationCode = try container.decode(String.self, forKey: .activationCode)
        stageUuid = try container.decode(String.self, forKey: .stageUuid)
    }
