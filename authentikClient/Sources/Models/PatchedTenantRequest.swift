...
/// Tenant Serializer 
public struct PatchedTenantRequest: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        _default = try container.decodeIfPresent(Bool.self, forKey: ._default)
        brandingTitle = try container.decodeIfPresent(String.self, forKey: .brandingTitle)
        brandingLogo = try container.decodeIfPresent(String.self, forKey: .brandingLogo)
        brandingFavicon = try container.decodeIfPresent(String.self, forKey: .brandingFavicon)
        flowAuthentication = try container.decodeIfPresent(UUID.self, forKey: .flowAuthentication)
        flowInvalidation = try container.decodeIfPresent(UUID.self, forKey: .flowInvalidation)
        flowRecovery = try container.decodeIfPresent(UUID.self, forKey: .flowRecovery)
        flowUnenrollment = try container.decodeIfPresent(UUID.self, forKey: .flowUnenrollment)
        flowUserSettings = try container.decodeIfPresent(UUID.self, forKey: .flowUserSettings)
