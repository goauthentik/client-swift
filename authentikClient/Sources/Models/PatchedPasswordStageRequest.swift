//
// PatchedPasswordStageRequest.swift
//
...
public struct PatchedPasswordStageRequest: Codable {
    ...
    public init(name: String? = nil, flowSet: [FlowSetRequest]? = nil, backends: [BackendsEnum]? = nil, configureFlow: UUID? = nil, failedAttemptsBeforeCancel: Int? = nil) {
        self.name = name
    ...
    public init(from decoder: Decoder) throws {
        ...
        backends = try container.decodeIfPresent([BackendsEnum].self, forKey: .backends)
