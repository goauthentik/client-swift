...
public struct PatchedRACProviderRequest: Codable, JSONEncodable, Hashable {
    ...
    public init(name: String? = nil, authenticationFlow: UUID? = nil, authorizationFlow: UUID? = nil, propertyMappings: [UUID]? = nil, settings: AnyCodable? = nil, connectionExpiry: String? = nil) {
        self.name = name
