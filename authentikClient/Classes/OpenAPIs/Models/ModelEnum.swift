...
public enum ModelEnum: String, Codable, CaseIterable, CaseIterableDefaultsLast {
    case tenantsPeriodDomain = "authentik_tenants.domain"
    ...
    case brandsPeriodBrand = "authentik_brands.brand"
    ...
    case providersRacPeriodRacprovider = "authentik_providers_rac.racprovider"
    case providersRacPeriodEndpoint = "authentik_providers_rac.endpoint"
    case providersRacPeriodRacpropertymapping = "authentik_providers_rac.racpropertymapping"
