...
public struct PatchedEventRequest: Codable, JSONEncodable, Hashable {
    ...
    public init(user: AnyCodable? = nil, action: EventActions? = nil, app: String? = nil, context: AnyCodable? = nil, clientIp: String? = nil, expires: Date? = nil, brand: AnyCodable? = nil) {
        self.user = user
        self.action = action
        self.app = app
