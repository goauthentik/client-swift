...
public struct NotificationRuleRequest: Codable, JSONEncodable, Hashable {
    ...
    public init(name: String, transports: [UUID]? = nil, severity: SeverityEnum? = nil, group: UUID? = nil) {
        self.name = name
