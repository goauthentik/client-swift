//
// AuthenticatorMobileStageRequest.swift
//
...
public struct AuthenticatorMobileStageRequest: Codable, JSONEncodable, Hashable {
    ...
    public init(name: String, flowSet: [FlowSetRequest]? = nil, configureFlow: UUID? = nil, friendlyName: String? = nil, itemMatchingMode: ItemMatchingModeEnum? = nil, cgwEndpoint: String) {
        self.name = name
