...
```swift
    open class func propertymappingsProviderScopeCreate(scopeMappingRequest: ScopeMappingRequest, completion: @escaping (_ data: ScopeMapping?, _ error: Error?) -> Void)
```
...
PropertymappingsAPI.propertymappingsProviderScopeCreate(scopeMappingRequest: scopeMappingRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func propertymappingsProviderScopeDestroy(pmUuid: UUID, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
PropertymappingsAPI.propertymappingsProviderScopeDestroy(pmUuid: pmUuid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func propertymappingsProviderScopeList(managed: [String]? = nil, managedIsnull: Bool? = nil, name: String? = nil, ordering: String? = nil, page: Int? = nil, pageSize: Int? = nil, scopeName: String? = nil, search: String? = nil, completion: @escaping (_ data: PaginatedScopeMappingList?, _ error: Error?) -> Void)
```
...
PropertymappingsAPI.propertymappingsProviderScopeList(managed: managed, managedIsnull: managedIsnull, name: name, ordering: ordering, page: page, pageSize: pageSize, scopeName: scopeName, search: search) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func propertymappingsProviderScopePartialUpdate(pmUuid: UUID, patchedScopeMappingRequest: PatchedScopeMappingRequest? = nil, completion: @escaping (_ data: ScopeMapping?, _ error: Error?) -> Void)
```
...
PropertymappingsAPI.propertymappingsProviderScopePartialUpdate(pmUuid: pmUuid, patchedScopeMappingRequest: patchedScopeMappingRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func propertymappingsProviderScopeRetrieve(pmUuid: UUID, completion: @escaping (_ data: ScopeMapping?, _ error: Error?) -> Void)
```
...
PropertymappingsAPI.propertymappingsProviderScopeRetrieve(pmUuid: pmUuid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func propertymappingsProviderScopeUpdate(pmUuid: UUID, scopeMappingRequest: ScopeMappingRequest, completion: @escaping (_ data: ScopeMapping?, _ error: Error?) -> Void)
```
...
PropertymappingsAPI.propertymappingsProviderScopeUpdate(pmUuid: pmUuid, scopeMappingRequest: scopeMappingRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func propertymappingsProviderScopeUsedByList(pmUuid: UUID, completion: @escaping (_ data: [UsedBy]?, _ error: Error?) -> Void)
```
...
PropertymappingsAPI.propertymappingsProviderScopeUsedByList(pmUuid: pmUuid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func propertymappingsSourceKerberosCreate(kerberosSourcePropertyMappingRequest: KerberosSourcePropertyMappingRequest, completion: @escaping (_ data: KerberosSourcePropertyMapping?, _ error: Error?) -> Void)
```
...
let kerberosSourcePropertyMappingRequest = KerberosSourcePropertyMappingRequest(managed: "managed_example", name: "name_example", expression: "expression_example") // KerberosSourcePropertyMappingRequest | 

PropertymappingsAPI.propertymappingsSourceKerberosCreate(kerberosSourcePropertyMappingRequest: kerberosSourcePropertyMappingRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func propertymappingsSourceKerberosDestroy(pmUuid: UUID, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
let pmUuid = 987 // UUID | A UUID string identifying this Kerberos Source Property Mapping.

PropertymappingsAPI.propertymappingsSourceKerberosDestroy(pmUuid: pmUuid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **pmUuid** | **UUID** | A UUID string identifying this Kerberos Source Property Mapping. | 
...
```swift
    open class func propertymappingsSourceKerberosList(managed: [String]? = nil, managedIsnull: Bool? = nil, name: String? = nil, ordering: String? = nil, page: Int? = nil, pageSize: Int? = nil, search: String? = nil, completion: @escaping (_ data: PaginatedKerberosSourcePropertyMappingList?, _ error: Error?) -> Void)
```
...
PropertymappingsAPI.propertymappingsSourceKerberosList(managed: managed, managedIsnull: managedIsnull, name: name, ordering: ordering, page: page, pageSize: pageSize, search: search) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func propertymappingsSourceKerberosPartialUpdate(pmUuid: UUID, patchedKerberosSourcePropertyMappingRequest: PatchedKerberosSourcePropertyMappingRequest? = nil, completion: @escaping (_ data: KerberosSourcePropertyMapping?, _ error: Error?) -> Void)
```
...
let pmUuid = 987 // UUID | A UUID string identifying this Kerberos Source Property Mapping.
let patchedKerberosSourcePropertyMappingRequest = PatchedKerberosSourcePropertyMappingRequest(managed: "managed_example", name: "name_example", expression: "expression_example") // PatchedKerberosSourcePropertyMappingRequest |  (optional)

PropertymappingsAPI.propertymappingsSourceKerberosPartialUpdate(pmUuid: pmUuid, patchedKerberosSourcePropertyMappingRequest: patchedKerberosSourcePropertyMappingRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func propertymappingsSourceKerberosRetrieve(pmUuid: UUID, completion: @escaping (_ data: KerberosSourcePropertyMapping?, _ error: Error?) -> Void)
```
...
PropertymappingsAPI.propertymappingsSourceKerberosRetrieve(pmUuid: pmUuid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func propertymappingsSourceKerberosUpdate(pmUuid: UUID, kerberosSourcePropertyMappingRequest: KerberosSourcePropertyMappingRequest, completion: @escaping (_ data: KerberosSourcePropertyMapping?, _ error: Error?) -> Void)
```
...
PropertymappingsAPI.propertymappingsSourceKerberosUpdate(pmUuid: pmUuid, kerberosSourcePropertyMappingRequest: kerberosSourcePropertyMappingRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func propertymappingsSourceKerberosUsedByList(pmUuid: UUID, completion: @escaping (_ data: [UsedBy]?, _ error: Error?) -> Void)
```
...
PropertymappingsAPI.propertymappingsSourceKerberosUsedByList(pmUuid: pmUuid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func propertymappingsSourceLdapCreate(lDAPSourcePropertyMappingRequest: LDAPSourcePropertyMappingRequest, completion: @escaping (_ data: LDAPSourcePropertyMapping?, _ error: Error?) -> Void)
```
...
let lDAPSourcePropertyMappingRequest = LDAPSourcePropertyMappingRequest(managed: "managed_example", name: "name_example", expression: "expression_example") // LDAPSourcePropertyMappingRequest | 

PropertymappingsAPI.propertymappingsSourceLdapCreate(lDAPSourcePropertyMappingRequest: lDAPSourcePropertyMappingRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func propertymappingsSourceLdapDestroy(pmUuid: UUID, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
let pmUuid = 987 // UUID | A UUID string identifying this LDAP Source Property Mapping.

PropertymappingsAPI.propertymappingsSourceLdapDestroy(pmUuid: pmUuid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **pmUuid** | **UUID** | A UUID string identifying this LDAP Source Property Mapping. | 
...
```swift
    open class func propertymappingsSourceLdapList(managed: [String]? = nil, managedIsnull: Bool? = nil, name: String? = nil, ordering: String? = nil, page: Int? = nil, pageSize: Int? = nil, search: String? = nil, completion: @escaping (_ data: PaginatedLDAPSourcePropertyMappingList?, _ error: Error?) -> Void)
```
...
PropertymappingsAPI.propertymappingsSourceLdapList(managed: managed, managedIsnull: managedIsnull, name: name, ordering: ordering, page: page, pageSize: pageSize, search: search) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func propertymappingsSourceLdapPartialUpdate(pmUuid: UUID, patchedLDAPSourcePropertyMappingRequest: PatchedLDAPSourcePropertyMappingRequest? = nil, completion: @escaping (_ data: LDAPSourcePropertyMapping?, _ error: Error?) -> Void)
```
...
let pmUuid = 987 // UUID | A UUID string identifying this LDAP Source Property Mapping.
let patchedLDAPSourcePropertyMappingRequest = PatchedLDAPSourcePropertyMappingRequest(managed: "managed_example", name: "name_example", expression: "expression_example") // PatchedLDAPSourcePropertyMappingRequest |  (optional)

PropertymappingsAPI.propertymappingsSourceLdapPartialUpdate(pmUuid: pmUuid, patchedLDAPSourcePropertyMappingRequest: patchedLDAPSourcePropertyMappingRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func propertymappingsSourceLdapRetrieve(pmUuid: UUID, completion: @escaping (_ data: LDAPSourcePropertyMapping?, _ error: Error?) -> Void)
```
...
PropertymappingsAPI.propertymappingsSourceLdapRetrieve(pmUuid: pmUuid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func propertymappingsSourceLdapUpdate(pmUuid: UUID, lDAPSourcePropertyMappingRequest: LDAPSourcePropertyMappingRequest, completion: @escaping (_ data: LDAPSourcePropertyMapping?, _ error: Error?) -> Void)
```
...
PropertymappingsAPI.propertymappingsSourceLdapUpdate(pmUuid: pmUuid, lDAPSourcePropertyMappingRequest: lDAPSourcePropertyMappingRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func propertymappingsSourceLdapUsedByList(pmUuid: UUID, completion: @escaping (_ data: [UsedBy]?, _ error: Error?) -> Void)
```
...
PropertymappingsAPI.propertymappingsSourceLdapUsedByList(pmUuid: pmUuid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func propertymappingsSourceOauthCreate(oAuthSourcePropertyMappingRequest: OAuthSourcePropertyMappingRequest, completion: @escaping (_ data: OAuthSourcePropertyMapping?, _ error: Error?) -> Void)
```
...
let oAuthSourcePropertyMappingRequest = OAuthSourcePropertyMappingRequest(managed: "managed_example", name: "name_example", expression: "expression_example") // OAuthSourcePropertyMappingRequest | 

PropertymappingsAPI.propertymappingsSourceOauthCreate(oAuthSourcePropertyMappingRequest: oAuthSourcePropertyMappingRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func propertymappingsSourceOauthDestroy(pmUuid: UUID, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
let pmUuid = 987 // UUID | A UUID string identifying this OAuth Source Property Mapping.

PropertymappingsAPI.propertymappingsSourceOauthDestroy(pmUuid: pmUuid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **pmUuid** | **UUID** | A UUID string identifying this OAuth Source Property Mapping. | 
...
```swift
    open class func propertymappingsSourceOauthList(managed: [String]? = nil, managedIsnull: Bool? = nil, name: String? = nil, ordering: String? = nil, page: Int? = nil, pageSize: Int? = nil, search: String? = nil, completion: @escaping (_ data: PaginatedOAuthSourcePropertyMappingList?, _ error: Error?) -> Void)
```
...
PropertymappingsAPI.propertymappingsSourceOauthList(managed: managed, managedIsnull: managedIsnull, name: name, ordering: ordering, page: page, pageSize: pageSize, search: search) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func propertymappingsSourceOauthPartialUpdate(pmUuid: UUID, patchedOAuthSourcePropertyMappingRequest: PatchedOAuthSourcePropertyMappingRequest? = nil, completion: @escaping (_ data: OAuthSourcePropertyMapping?, _ error: Error?) -> Void)
```
...
let pmUuid = 987 // UUID | A UUID string identifying this OAuth Source Property Mapping.
let patchedOAuthSourcePropertyMappingRequest = PatchedOAuthSourcePropertyMappingRequest(managed: "managed_example", name: "name_example", expression: "expression_example") // PatchedOAuthSourcePropertyMappingRequest |  (optional)

PropertymappingsAPI.propertymappingsSourceOauthPartialUpdate(pmUuid: pmUuid, patchedOAuthSourcePropertyMappingRequest: patchedOAuthSourcePropertyMappingRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func propertymappingsSourceOauthRetrieve(pmUuid: UUID, completion: @escaping (_ data: OAuthSourcePropertyMapping?, _ error: Error?) -> Void)
```
...
PropertymappingsAPI.propertymappingsSourceOauthRetrieve(pmUuid: pmUuid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func propertymappingsSourceOauthUpdate(pmUuid: UUID, oAuthSourcePropertyMappingRequest: OAuthSourcePropertyMappingRequest, completion: @escaping (_ data: OAuthSourcePropertyMapping?, _ error: Error?) -> Void)
```
...
PropertymappingsAPI.propertymappingsSourceOauthUpdate(pmUuid: pmUuid, oAuthSourcePropertyMappingRequest: oAuthSourcePropertyMappingRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func propertymappingsSourceOauthUsedByList(pmUuid: UUID, completion: @escaping (_ data: [UsedBy]?, _ error: Error?) -> Void)
```
...
PropertymappingsAPI.propertymappingsSourceOauthUsedByList(pmUuid: pmUuid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func propertymappingsSourcePlexCreate(plexSourcePropertyMappingRequest: PlexSourcePropertyMappingRequest, completion: @escaping (_ data: PlexSourcePropertyMapping?, _ error: Error?) -> Void)
```
...
let plexSourcePropertyMappingRequest = PlexSourcePropertyMappingRequest(managed: "managed_example", name: "name_example", expression: "expression_example") // PlexSourcePropertyMappingRequest | 

PropertymappingsAPI.propertymappingsSourcePlexCreate(plexSourcePropertyMappingRequest: plexSourcePropertyMappingRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func propertymappingsSourcePlexDestroy(pmUuid: UUID, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
let pmUuid = 987 // UUID | A UUID string identifying this Plex Source Property Mapping.

PropertymappingsAPI.propertymappingsSourcePlexDestroy(pmUuid: pmUuid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **pmUuid** | **UUID** | A UUID string identifying this Plex Source Property Mapping. | 
...
```swift
    open class func propertymappingsSourcePlexList(managed: [String]? = nil, managedIsnull: Bool? = nil, name: String? = nil, ordering: String? = nil, page: Int? = nil, pageSize: Int? = nil, search: String? = nil, completion: @escaping (_ data: PaginatedPlexSourcePropertyMappingList?, _ error: Error?) -> Void)
```
...
PropertymappingsAPI.propertymappingsSourcePlexList(managed: managed, managedIsnull: managedIsnull, name: name, ordering: ordering, page: page, pageSize: pageSize, search: search) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func propertymappingsSourcePlexPartialUpdate(pmUuid: UUID, patchedPlexSourcePropertyMappingRequest: PatchedPlexSourcePropertyMappingRequest? = nil, completion: @escaping (_ data: PlexSourcePropertyMapping?, _ error: Error?) -> Void)
```
...
let pmUuid = 987 // UUID | A UUID string identifying this Plex Source Property Mapping.
let patchedPlexSourcePropertyMappingRequest = PatchedPlexSourcePropertyMappingRequest(managed: "managed_example", name: "name_example", expression: "expression_example") // PatchedPlexSourcePropertyMappingRequest |  (optional)

PropertymappingsAPI.propertymappingsSourcePlexPartialUpdate(pmUuid: pmUuid, patchedPlexSourcePropertyMappingRequest: patchedPlexSourcePropertyMappingRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func propertymappingsSourcePlexRetrieve(pmUuid: UUID, completion: @escaping (_ data: PlexSourcePropertyMapping?, _ error: Error?) -> Void)
```
...
PropertymappingsAPI.propertymappingsSourcePlexRetrieve(pmUuid: pmUuid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func propertymappingsSourcePlexUpdate(pmUuid: UUID, plexSourcePropertyMappingRequest: PlexSourcePropertyMappingRequest, completion: @escaping (_ data: PlexSourcePropertyMapping?, _ error: Error?) -> Void)
```
...
PropertymappingsAPI.propertymappingsSourcePlexUpdate(pmUuid: pmUuid, plexSourcePropertyMappingRequest: plexSourcePropertyMappingRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func propertymappingsSourcePlexUsedByList(pmUuid: UUID, completion: @escaping (_ data: [UsedBy]?, _ error: Error?) -> Void)
```
...
PropertymappingsAPI.propertymappingsSourcePlexUsedByList(pmUuid: pmUuid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func propertymappingsSourceSamlCreate(sAMLSourcePropertyMappingRequest: SAMLSourcePropertyMappingRequest, completion: @escaping (_ data: SAMLSourcePropertyMapping?, _ error: Error?) -> Void)
```
...
let sAMLSourcePropertyMappingRequest = SAMLSourcePropertyMappingRequest(managed: "managed_example", name: "name_example", expression: "expression_example") // SAMLSourcePropertyMappingRequest | 

PropertymappingsAPI.propertymappingsSourceSamlCreate(sAMLSourcePropertyMappingRequest: sAMLSourcePropertyMappingRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func propertymappingsSourceSamlDestroy(pmUuid: UUID, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
let pmUuid = 987 // UUID | A UUID string identifying this SAML Source Property Mapping.

PropertymappingsAPI.propertymappingsSourceSamlDestroy(pmUuid: pmUuid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **pmUuid** | **UUID** | A UUID string identifying this SAML Source Property Mapping. | 
...
```swift
    open class func propertymappingsSourceSamlList(managed: [String]? = nil, managedIsnull: Bool? = nil, name: String? = nil, ordering: String? = nil, page: Int? = nil, pageSize: Int? = nil, search: String? = nil, completion: @escaping (_ data: PaginatedSAMLSourcePropertyMappingList?, _ error: Error?) -> Void)
```
...
PropertymappingsAPI.propertymappingsSourceSamlList(managed: managed, managedIsnull: managedIsnull, name: name, ordering: ordering, page: page, pageSize: pageSize, search: search) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func propertymappingsSourceSamlPartialUpdate(pmUuid: UUID, patchedSAMLSourcePropertyMappingRequest: PatchedSAMLSourcePropertyMappingRequest? = nil, completion: @escaping (_ data: SAMLSourcePropertyMapping?, _ error: Error?) -> Void)
```
...
let pmUuid = 987 // UUID | A UUID string identifying this SAML Source Property Mapping.
let patchedSAMLSourcePropertyMappingRequest = PatchedSAMLSourcePropertyMappingRequest(managed: "managed_example", name: "name_example", expression: "expression_example") // PatchedSAMLSourcePropertyMappingRequest |  (optional)

PropertymappingsAPI.propertymappingsSourceSamlPartialUpdate(pmUuid: pmUuid, patchedSAMLSourcePropertyMappingRequest: patchedSAMLSourcePropertyMappingRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func propertymappingsSourceSamlRetrieve(pmUuid: UUID, completion: @escaping (_ data: SAMLSourcePropertyMapping?, _ error: Error?) -> Void)
```
...
PropertymappingsAPI.propertymappingsSourceSamlRetrieve(pmUuid: pmUuid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func propertymappingsSourceSamlUpdate(pmUuid: UUID, sAMLSourcePropertyMappingRequest: SAMLSourcePropertyMappingRequest, completion: @escaping (_ data: SAMLSourcePropertyMapping?, _ error: Error?) -> Void)
```
...
PropertymappingsAPI.propertymappingsSourceSamlUpdate(pmUuid: pmUuid, sAMLSourcePropertyMappingRequest: sAMLSourcePropertyMappingRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func propertymappingsSourceSamlUsedByList(pmUuid: UUID, completion: @escaping (_ data: [UsedBy]?, _ error: Error?) -> Void)
```
...
PropertymappingsAPI.propertymappingsSourceSamlUsedByList(pmUuid: pmUuid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func propertymappingsSourceScimCreate(sCIMSourcePropertyMappingRequest: SCIMSourcePropertyMappingRequest, completion: @escaping (_ data: SCIMSourcePropertyMapping?, _ error: Error?) -> Void)
```
...
let sCIMSourcePropertyMappingRequest = SCIMSourcePropertyMappingRequest(managed: "managed_example", name: "name_example", expression: "expression_example") // SCIMSourcePropertyMappingRequest | 

PropertymappingsAPI.propertymappingsSourceScimCreate(sCIMSourcePropertyMappingRequest: sCIMSourcePropertyMappingRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func propertymappingsSourceScimDestroy(pmUuid: UUID, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
let pmUuid = 987 // UUID | A UUID string identifying this SCIM Source Property Mapping.

PropertymappingsAPI.propertymappingsSourceScimDestroy(pmUuid: pmUuid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func propertymappingsSourceScimList(managed: [String]? = nil, managedIsnull: Bool? = nil, name: String? = nil, ordering: String? = nil, page: Int? = nil, pageSize: Int? = nil, search: String? = nil, completion: @escaping (_ data: PaginatedSCIMSourcePropertyMappingList?, _ error: Error?) -> Void)
```
...
PropertymappingsAPI.propertymappingsSourceScimList(managed: managed, managedIsnull: managedIsnull, name: name, ordering: ordering, page: page, pageSize: pageSize, search: search) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func propertymappingsSourceScimPartialUpdate(pmUuid: UUID, patchedSCIMSourcePropertyMappingRequest: PatchedSCIMSourcePropertyMappingRequest? = nil, completion: @escaping (_ data: SCIMSourcePropertyMapping?, _ error: Error?) -> Void)
```
...
let pmUuid = 987 // UUID | A UUID string identifying this SCIM Source Property Mapping.
let patchedSCIMSourcePropertyMappingRequest = PatchedSCIMSourcePropertyMappingRequest(managed: "managed_example", name: "name_example", expression: "expression_example") // PatchedSCIMSourcePropertyMappingRequest |  (optional)

PropertymappingsAPI.propertymappingsSourceScimPartialUpdate(pmUuid: pmUuid, patchedSCIMSourcePropertyMappingRequest: patchedSCIMSourcePropertyMappingRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func propertymappingsSourceScimRetrieve(pmUuid: UUID, completion: @escaping (_ data: SCIMSourcePropertyMapping?, _ error: Error?) -> Void)
```
...
PropertymappingsAPI.propertymappingsSourceScimRetrieve(pmUuid: pmUuid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func propertymappingsSourceScimUpdate(pmUuid: UUID, sCIMSourcePropertyMappingRequest: SCIMSourcePropertyMappingRequest, completion: @escaping (_ data: SCIMSourcePropertyMapping?, _ error: Error?) -> Void)
```
...
PropertymappingsAPI.propertymappingsSourceScimUpdate(pmUuid: pmUuid, sCIMSourcePropertyMappingRequest: sCIMSourcePropertyMappingRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func propertymappingsSourceScimUsedByList(pmUuid: UUID, completion: @escaping (_ data: [UsedBy]?, _ error: Error?) -> Void)
```
...
PropertymappingsAPI.propertymappingsSourceScimUsedByList(pmUuid: pmUuid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
