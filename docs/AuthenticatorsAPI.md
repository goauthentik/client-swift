...
[**authenticatorsAdminMobileDestroy**](AuthenticatorsAPI.md#authenticatorsadminmobiledestroy) | **DELETE** /authenticators/admin/mobile/{id}/ | 
[**authenticatorsAdminMobileList**](AuthenticatorsAPI.md#authenticatorsadminmobilelist) | **GET** /authenticators/admin/mobile/ | 
[**authenticatorsAdminMobilePartialUpdate**](AuthenticatorsAPI.md#authenticatorsadminmobilepartialupdate) | **PATCH** /authenticators/admin/mobile/{id}/ | 
[**authenticatorsAdminMobileRetrieve**](AuthenticatorsAPI.md#authenticatorsadminmobileretrieve) | **GET** /authenticators/admin/mobile/{id}/ | 
[**authenticatorsAdminMobileUpdate**](AuthenticatorsAPI.md#authenticatorsadminmobileupdate) | **PUT** /authenticators/admin/mobile/{id}/ | 
...
[**authenticatorsMobileDestroy**](AuthenticatorsAPI.md#authenticatorsmobiledestroy) | **DELETE** /authenticators/mobile/{id}/ | 
[**authenticatorsMobileList**](AuthenticatorsAPI.md#authenticatorsmobilelist) | **GET** /authenticators/mobile/ | 
[**authenticatorsMobilePartialUpdate**](AuthenticatorsAPI.md#authenticatorsmobilepartialupdate) | **PATCH** /authenticators/mobile/{id}/ | 
[**authenticatorsMobileRetrieve**](AuthenticatorsAPI.md#authenticatorsmobileretrieve) | **GET** /authenticators/mobile/{id}/ | 
[**authenticatorsMobileUpdate**](AuthenticatorsAPI.md#authenticatorsmobileupdate) | **PUT** /authenticators/mobile/{id}/ | 
[**authenticatorsMobileUsedByList**](AuthenticatorsAPI.md#authenticatorsmobileusedbylist) | **GET** /authenticators/mobile/{id}/used_by/ | 
...
let mobileDeviceRequest = MobileDeviceRequest(name: "name_example") // MobileDeviceRequest | 
...
```swift
    open class func authenticatorsAdminMobileDestroy(id: Int, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
let id = 987 // Int | A unique integer value identifying this Mobile Device.

AuthenticatorsAPI.authenticatorsAdminMobileDestroy(id: id) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | **Int** | A unique integer value identifying this Mobile Device. | 
...
```swift
    open class func authenticatorsAdminMobilePartialUpdate(id: Int, patchedMobileDeviceRequest: PatchedMobileDeviceRequest? = nil, completion: @escaping (_ data: MobileDevice?, _ error: Error?) -> Void)
```
...
let id = 987 // Int | A unique integer value identifying this Mobile Device.
let patchedMobileDeviceRequest = PatchedMobileDeviceRequest(name: "name_example") // PatchedMobileDeviceRequest |  (optional)

AuthenticatorsAPI.authenticatorsAdminMobilePartialUpdate(id: id, patchedMobileDeviceRequest: patchedMobileDeviceRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func authenticatorsAdminMobileRetrieve(id: Int, completion: @escaping (_ data: MobileDevice?, _ error: Error?) -> Void)
```
...
AuthenticatorsAPI.authenticatorsAdminMobileRetrieve(id: id) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func authenticatorsAdminMobileUpdate(id: Int, mobileDeviceRequest: MobileDeviceRequest, completion: @escaping (_ data: MobileDevice?, _ error: Error?) -> Void)
```
...
AuthenticatorsAPI.authenticatorsAdminMobileUpdate(id: id, mobileDeviceRequest: mobileDeviceRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func authenticatorsMobileDestroy(id: Int, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
AuthenticatorsAPI.authenticatorsMobileDestroy(id: id) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func authenticatorsMobilePartialUpdate(id: Int, patchedMobileDeviceRequest: PatchedMobileDeviceRequest? = nil, completion: @escaping (_ data: MobileDevice?, _ error: Error?) -> Void)
```
...
AuthenticatorsAPI.authenticatorsMobilePartialUpdate(id: id, patchedMobileDeviceRequest: patchedMobileDeviceRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func authenticatorsMobileRetrieve(id: Int, completion: @escaping (_ data: MobileDevice?, _ error: Error?) -> Void)
```
...
AuthenticatorsAPI.authenticatorsMobileRetrieve(id: id) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func authenticatorsMobileUpdate(id: Int, mobileDeviceRequest: MobileDeviceRequest, completion: @escaping (_ data: MobileDevice?, _ error: Error?) -> Void)
```
...
AuthenticatorsAPI.authenticatorsMobileUpdate(id: id, mobileDeviceRequest: mobileDeviceRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func authenticatorsMobileUsedByList(id: Int, completion: @escaping (_ data: [UsedBy]?, _ error: Error?) -> Void)
```
...
AuthenticatorsAPI.authenticatorsMobileUsedByList(id: id) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func authenticatorsStaticList(name: String? = nil, ordering: String? = nil, page: Int? = nil, pageSize: Int? = nil, search: String? = nil, completion: @escaping (_ data: PaginatedStaticDeviceList?, _ error: Error?) -> Void)
```
...
AuthenticatorsAPI.authenticatorsStaticList(name: name, ordering: ordering, page: page, pageSize: pageSize, search: search) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func authenticatorsStaticPartialUpdate(id: Int, patchedStaticDeviceRequest: PatchedStaticDeviceRequest? = nil, completion: @escaping (_ data: StaticDevice?, _ error: Error?) -> Void)
```
...
```swift
    open class func authenticatorsStaticRetrieve(id: Int, completion: @escaping (_ data: StaticDevice?, _ error: Error?) -> Void)
```
...
```swift
    open class func authenticatorsStaticUpdate(id: Int, staticDeviceRequest: StaticDeviceRequest, completion: @escaping (_ data: StaticDevice?, _ error: Error?) -> Void)
```
...
```swift
    open class func authenticatorsStaticUsedByList(id: Int, completion: @escaping (_ data: [UsedBy]?, _ error: Error?) -> Void)
```
...
```swift
    open class func authenticatorsTotpDestroy(id: Int, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
```swift
    open class func authenticatorsTotpList(name: String? = nil, ordering: String? = nil, page: Int? = nil, pageSize: Int? = nil, search: String? = nil, completion: @escaping (_ data: PaginatedTOTPDeviceList?, _ error: Error?) -> Void)
```
...
AuthenticatorsAPI.authenticatorsTotpList(name: name, ordering: ordering, page: page, pageSize: pageSize, search: search) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func authenticatorsTotpPartialUpdate(id: Int, patchedTOTPDeviceRequest: PatchedTOTPDeviceRequest? = nil, completion: @escaping (_ data: TOTPDevice?, _ error: Error?) -> Void)
```
...
```swift
    open class func authenticatorsTotpRetrieve(id: Int, completion: @escaping (_ data: TOTPDevice?, _ error: Error?) -> Void)
```
...
```swift
    open class func authenticatorsTotpUpdate(id: Int, tOTPDeviceRequest: TOTPDeviceRequest, completion: @escaping (_ data: TOTPDevice?, _ error: Error?) -> Void)
```
...
```swift
    open class func authenticatorsTotpUsedByList(id: Int, completion: @escaping (_ data: [UsedBy]?, _ error: Error?) -> Void)
```
...
```swift
    open class func authenticatorsWebauthnDestroy(id: Int, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
AuthenticatorsAPI.authenticatorsWebauthnDestroy(id: id) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func authenticatorsWebauthnList(name: String? = nil, ordering: String? = nil, page: Int? = nil, pageSize: Int? = nil, search: String? = nil, completion: @escaping (_ data: PaginatedWebAuthnDeviceList?, _ error: Error?) -> Void)
```
...
AuthenticatorsAPI.authenticatorsWebauthnList(name: name, ordering: ordering, page: page, pageSize: pageSize, search: search) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func authenticatorsWebauthnPartialUpdate(id: Int, patchedWebAuthnDeviceRequest: PatchedWebAuthnDeviceRequest? = nil, completion: @escaping (_ data: WebAuthnDevice?, _ error: Error?) -> Void)
```
...
```swift
    open class func authenticatorsWebauthnRetrieve(id: Int, completion: @escaping (_ data: WebAuthnDevice?, _ error: Error?) -> Void)
```
...
AuthenticatorsAPI.authenticatorsWebauthnRetrieve(id: id) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func authenticatorsWebauthnUpdate(id: Int, webAuthnDeviceRequest: WebAuthnDeviceRequest, completion: @escaping (_ data: WebAuthnDevice?, _ error: Error?) -> Void)
```
...
```swift
    open class func authenticatorsWebauthnUsedByList(id: Int, completion: @escaping (_ data: [UsedBy]?, _ error: Error?) -> Void)
```
...
AuthenticatorsAPI.authenticatorsWebauthnUsedByList(id: id) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
