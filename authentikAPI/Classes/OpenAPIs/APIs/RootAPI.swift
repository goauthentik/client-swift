...
open class RootAPI {
     ...
     */
    @discardableResult
    open class func rootConfigRetrieve(apiResponseQueue: DispatchQueue = authentikAPIAPI.apiResponseQueue, completion: @escaping ((_ data: Config?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func rootConfigRetrieveWithRequestBuilder() -> RequestBuilder<Config> {
        ...
        let localVariableRequestBuilder: RequestBuilder<Config>.Type = authentikAPIAPI.requestBuilderFactory.getBuilder()
