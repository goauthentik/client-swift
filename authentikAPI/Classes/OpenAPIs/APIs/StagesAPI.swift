...
open class StagesAPI {
     ...
     */
    @discardableResult
    open class func stagesAuthenticatorMobileCreate(authenticatorMobileStageRequest: AuthenticatorMobileStageRequest, apiResponseQueue: DispatchQueue = authentikAPIAPI.apiResponseQueue, completion: @escaping ((_ data: AuthenticatorMobileStage?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func stagesAuthenticatorMobileCreateWithRequestBuilder(authenticatorMobileStageRequest: AuthenticatorMobileStageRequest) -> RequestBuilder<AuthenticatorMobileStage> {
        ...
        let localVariableRequestBuilder: RequestBuilder<AuthenticatorMobileStage>.Type = authentikAPIAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func stagesAuthenticatorMobileDestroy(stageUuid: UUID, apiResponseQueue: DispatchQueue = authentikAPIAPI.apiResponseQueue, completion: @escaping ((_ data: Void?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    @discardableResult
    open class func stagesAuthenticatorMobileEnrollmentCallbackRetrieve(stageUuid: UUID, apiResponseQueue: DispatchQueue = authentikAPIAPI.apiResponseQueue, completion: @escaping ((_ data: AuthenticatorMobileStage?, _ error: Error?) -> Void)) -> RequestTask {
        return stagesAuthenticatorMobileEnrollmentCallbackRetrieveWithRequestBuilder(stageUuid: stageUuid).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     - GET /stages/authenticator/mobile/{stage_uuid}/enrollment_callback/
     - AuthenticatorMobileStage Viewset
     - API Key:
       - type: apiKey Authorization 
       - name: authentik
     ...
     - returns: RequestBuilder<AuthenticatorMobileStage> 
     */
    open class func stagesAuthenticatorMobileEnrollmentCallbackRetrieveWithRequestBuilder(stageUuid: UUID) -> RequestBuilder<AuthenticatorMobileStage> {
        var localVariablePath = "/stages/authenticator/mobile/{stage_uuid}/enrollment_callback/"
        let stageUuidPreEscape = "\(APIHelper.mapValueToPathItem(stageUuid))"
        let stageUuidPostEscape = stageUuidPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{stage_uuid}", with: stageUuidPostEscape, options: .literal, range: nil)
        let localVariableURLString = authentikAPIAPI.basePath + localVariablePath
    ...
    open class func stagesAuthenticatorMobileListWithRequestBuilder(configureFlow: UUID? = nil, name: String? = nil, ordering: String? = nil, page: Int? = nil, pageSize: Int? = nil, search: String? = nil) -> RequestBuilder<PaginatedAuthenticatorMobileStageList> {
        ...
        let localVariableRequestBuilder: RequestBuilder<PaginatedAuthenticatorMobileStageList>.Type = authentikAPIAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func stagesAuthenticatorMobilePartialUpdate(stageUuid: UUID, patchedAuthenticatorMobileStageRequest: PatchedAuthenticatorMobileStageRequest? = nil, apiResponseQueue: DispatchQueue = authentikAPIAPI.apiResponseQueue, completion: @escaping ((_ data: AuthenticatorMobileStage?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    @discardableResult
    open class func stagesAuthenticatorMobileRetrieve(stageUuid: UUID, apiResponseQueue: DispatchQueue = authentikAPIAPI.apiResponseQueue, completion: @escaping ((_ data: AuthenticatorMobileStage?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    @discardableResult
    open class func stagesAuthenticatorMobileUpdate(stageUuid: UUID, authenticatorMobileStageRequest: AuthenticatorMobileStageRequest, apiResponseQueue: DispatchQueue = authentikAPIAPI.apiResponseQueue, completion: @escaping ((_ data: AuthenticatorMobileStage?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    @discardableResult
    open class func stagesAuthenticatorMobileUsedByList(stageUuid: UUID, apiResponseQueue: DispatchQueue = authentikAPIAPI.apiResponseQueue, completion: @escaping ((_ data: [UsedBy]?, _ error: Error?) -> Void)) -> RequestTask {
