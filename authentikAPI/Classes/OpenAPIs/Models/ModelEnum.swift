...
public enum ModelEnum: String, Codable, CaseIterable, CaseIterableDefaultsLast {
    ...
    case stagesAuthenticatorMobilePeriodAuthenticatormobilestage = "authentik_stages_authenticator_mobile.authenticatormobilestage"
    case stagesAuthenticatorMobilePeriodMobiledevice = "authentik_stages_authenticator_mobile.mobiledevice"
