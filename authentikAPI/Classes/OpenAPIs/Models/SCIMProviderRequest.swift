...
public struct SCIMProviderRequest: Codable, JSONEncodable, Hashable {
    ...
    public init(name: String, propertyMappings: [UUID]? = nil, propertyMappingsGroup: [UUID]? = nil, url: String, token: String, excludeUsersServiceAccount: Bool? = nil, filterGroup: UUID? = nil) {
        self.name = name
