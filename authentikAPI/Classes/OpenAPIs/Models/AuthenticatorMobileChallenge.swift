...
public struct AuthenticatorMobileChallenge: Codable, JSONEncodable, Hashable {
    ...
    public var authentikUrl: String
    public var stageUuid: String

    public init(type: ChallengeChoices, flowInfo: ContextualFlowInfo? = nil, component: String? = "ak-stage-authenticator-mobile", responseErrors: [String: [ErrorDetail]]? = nil, pendingUser: String, pendingUserAvatar: String, authentikUrl: String, stageUuid: String) {
        self.type = type
        ...
        self.authentikUrl = authentikUrl
    ...
    public enum CodingKeys: String, CodingKey, CaseIterable {
        ...
        case authentikUrl = "authentik_url"
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(authentikUrl, forKey: .authentikUrl)
