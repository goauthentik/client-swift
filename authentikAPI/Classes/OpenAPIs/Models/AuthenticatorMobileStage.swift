...
public struct AuthenticatorMobileStage: Codable, JSONEncodable, Hashable {
    ...
    public init(pk: UUID, name: String, component: String, verboseName: String, verboseNamePlural: String, metaModelName: String, flowSet: [FlowSet]? = nil, configureFlow: UUID? = nil, friendlyName: String? = nil) {
        self.pk = pk
        self.name = name
