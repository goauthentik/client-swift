//
// AuthenticatorStaticChallenge.swift
//
...
public struct AuthenticatorStaticChallenge: Codable, JSONEncodable, Hashable {
    ...
    public init(type: ChallengeChoices, flowInfo: ContextualFlowInfo? = nil, component: String? = "ak-stage-authenticator-static", responseErrors: [String: [ErrorDetail]]? = nil, pendingUser: String, pendingUserAvatar: String, codes: [String]) {
        self.type = type
